            ...
            .then(async (userCredential) => {
                ...
                if (user === null) {
                    toast({
                        ...
                        description: "Your account couldn't be created due to some issues. Please check you email and password again.",
                    })
                }
                ...
                sendEmailVerification(user).then(() => {
                    toast({
                        ...
                        description: "See your email and click on the verification link.",
                    })
                })
            })
            .catch((error) => {
